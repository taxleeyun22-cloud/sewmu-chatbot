/**
 * shadcn/ui Card — 5 sub components (Card / Header / Title / Description / Content / Footer).
 */
'use client';
...
/* Phase 15 audit fix: ref 타입 mismatch (HTMLParagraphElement → HTMLHeadingElement). */
