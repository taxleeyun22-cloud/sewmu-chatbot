...
export async function onRequestGet(context) {
  ...
  const status = url.searchParams.get("status"); // pending / approved_client / approved_guest / rejected / all
  try {
    let query = `
...
// POST: 승인/거절 처리 { user_id, action: 'approve_client'|'approve_guest'|'reject', reason? }
