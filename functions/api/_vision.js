...
1단계 — 문서 종류 판별:
  "receipt"       = 영수증/간이영수증/카드전표/현금영수증
  "tax_invoice"   = 세금계산서/계산서 (종이·수기)
  "lease"         = 부동산 임대차 계약서
  "payroll"       = 근로계약서/급여명세서
  "insurance"     = 보험 증권/보험 계약서
  "utility"       = 공과금 고지서 (전기/수도/가스/통신)
  "property_tax"  = 자동차세/재산세/지방세 고지서
  "bank_stmt"     = 은행 입출금 내역/카드 명세
  "business_reg"  = 사업자등록증·사업자등록증명
  "identity"      = 신분증·주민등록등본·통장사본
  "contract"      = 외주·용역·매매 계약서 (부동산 임대 제외)
  "other"         = 위 어디에도 안 맞는 세무 관련 or 불명확
