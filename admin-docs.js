...
/* 풀스크린 이미지 뷰어 — src/lib/img-viewer.ts (모듈화 #2, 2026-05-18) 로 이전.
 * window.openImgViewer/closeImgViewer/imgViewerNav/saveImgViewer/collectImagesNear
 * 는 main.js(ESM) 가 self-register → admin·business.html 둘 다 제공.
 * (closeImgViewer Sentry 근본fix: 여기 복사본 + business.html shim 제거) */
